...
import json
import os
from plot_data import PlotLoader
...
upsampled_full_set = [UpSample(image, new_dim) for image in FULL_dataset.data]
upsampled_test_set = [UpSample(image, new_dim) for image in test_dataset.data]
...
val_size = val_percentage*len(new_train_dataset)
